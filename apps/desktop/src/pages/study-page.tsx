...
export function DesktopStudyPage(): React.ReactElement {
  const { deckId: deckIdParam } = useParams({ strict: false }) as {
    deckId: string;
  };
        ...
        <div className="mx-auto flex h-14 max-w-4xl items-center gap-3 px-4">
          ...
          {lastReviewedCardId && (
            ...
            >
              ...
              Undo
              <span className="ml-1 text-xs text-muted-foreground/60">(Z)</span>
            </Button>
          )}
        </div>
      </header>
              ...
              <div className="mx-auto flex h-20 w-full max-w-2xl items-center justify-center">
                {showAnswer ? (
                  ...
                  <button
                    ...
                    className="w-full rounded-xl border bg-card px-6 py-3 text-sm font-medium text-muted-foreground transition-colors hover:bg-muted/50 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                  >
                    Show Answer
...
function CongratsScreen({
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 text-center">
      ...
      <div>
        <h2 className="mb-1 text-xl font-semibold">Congratulations!</h2>
        <p className="text-sm text-muted-foreground">
